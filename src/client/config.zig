...
pub const renderer = struct {
    ...
    pub const ping_good_ms: f32 = 20.0;
    pub const ping_warn_ms: f32 = 80.0;
    pub const ping_color_good = color(80, 214, 124, 255);
    pub const ping_color_warn = color(247, 196, 80, 255);
    pub const ping_color_bad = color(235, 94, 94, 255);
    pub const ping_color_na = color(205, 210, 220, 255);
...
pub const profiler = struct {
    ...
    pub const panel_line_gap: f32 = 18.0;
    pub const graph_height: f32 = 96.0;
    pub const timing_graph_height: f32 = 156.0;
    pub const graph_top_gap: f32 = 8.0;
    pub const graph_left_gutter: f32 = 72.0;
    pub const graph_right_gutter: f32 = 6.0;
    pub const graph_header_height: f32 = 24.0;
    pub const graph_bottom_padding: f32 = 14.0;
    pub const graph_axis_text_x: f32 = 6.0;
    pub const graph_axis_tick_y_offset: f32 = 8.0;
    pub const graph_x_label_width: f32 = 108.0;
    pub const legend_y_offset: f32 = 20.0;
    pub const legend_x_start: f32 = 8.0;
    pub const legend_item_gap: f32 = 82.0;
    ...
    pub const graph_grid = color(58, 63, 76, 160);
    pub const graph_axis_text = color(188, 196, 212, 255);
    pub const network_graph_height: f32 = 86.0;
    pub const network_graph_split_gap: f32 = 6.0;
